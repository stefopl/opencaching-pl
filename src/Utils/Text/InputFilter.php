...
/**
 * This class allow to remove only selected tags from user text - allow for html formatting of the text
 *
 * @class: InputFilter (PHP4 & PHP5, with comments) + OCPL customizations
...
//      $source = mb_eregi_replace('&#x([a-f0-9]+);',"chr(0x\\1)", $source);    // hex notation
     ...
     *
     */
    private function wellFormTagWithAttr($tag)
    {
        /** replace '  ' by ' '
