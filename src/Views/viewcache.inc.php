...
$gallery_icon = '<img src="images/free_icons/photo.png" alt="Photo" class="icon16"/>';
...
$note_icon = '<img src="images/log/16x16-note.png" class="icon16" alt="{{log_note}}" />';
$exist_icon = '<img src="images/log/16x16-attend.png" class="icon16" alt="" title="uczestniczył"/>';
$trash_icon = '<img src="images/log/16x16-trash.png" class="icon16" alt="" />';
$wattend_icon = '<img src="images/log/16x16-will_attend.png" class="icon16" alt="" title="będzie uczestniczył"/>';
$hide_del_tr = tr('vc_HideDeletions');
$hide_del_link = '<span style="white-space: nowrap;"><a href="{thispage}?cacheid={cacheid}&amp;showdel=n' . $linkargs . '#log_start" title="' . $hide_del_tr . '">' . '<img src="images/log/16x16-trash.png" class="icon16" alt="' . $hide_del_tr . '" title="' . $hide_del_tr . '" /></a>&nbsp;<a href="{thispage}?cacheid={cacheid}&amp;showdel=n' . $linkargs . '#log_start" title="' . $hide_del_tr . '">' . $hide_del_tr . '</a></span>';
